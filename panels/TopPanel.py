...
class TopPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        title = wx.StaticText(self, -1, 'Check out this weather app!', style=wx.ALIGN_CENTER, size=(parent.width, 50))
        ...
        text = wx.StaticText(self, -1,
                             ...
                             "smoothed with a filter. The mouse over is enabled for the smooth curves " +
                             "only and shows the date and value at that point of the curve. The first day " +
                             "of summer is calculated from defining summer as the warmest three months " +
                             "of the year. The temperature increase over the years is shown with the year " +
                             "curve. Curves can be also be made for wind, sunshine and rain.",
                             style=wx.ALIGN_CENTER)

        text.Wrap(parent.width - 25)
